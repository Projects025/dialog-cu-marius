...
export default function FormsPage() {
  ...
  const restoreMasterTemplate = () => {
    setConfirmTitle("Regenerare Master Form");
    setConfirmDescription("ATENȚIE: Se va regenera formularul Master cu toate cele 4 fluxuri, inclusiv listele de verificare și calculele. Ești sigur?");
    setConfirmButtonText("Da, Regenerează");
    setConfirmButtonVariant("destructive");

    setConfirmAction(() => async () => {
      try {
        // 1. Curățăm vechiul master
        await deleteDoc(doc(db, "formTemplates", "master_standard_v1")).catch(() => {});

        // 2. Definim structura completă
        const masterData = {
          ...
          flow: {
            ...
            // =================================================
            // 2. SCENARIUL DECES (Complet)
            // =================================================
            deces_intro_1: { message: ["Un deces afectează negativ profund și pe termen lung atât **planul existențial** (drama pierderii), cât și **planul financiar** (dispariția opțiunilor)."], actionType: "buttons", options: ["Continuă"], nextStep: "deces_intro_2" },
            ...
            deces_ask_event_costs: { message: "2. Ce sumă unică (în lei) ar fi necesară pentru cheltuieli imediate (ex. înmormântare, taxe)?", actionType: "input", options: { type: "number", placeholder: "Ex: 20000" }, nextStep: "deces_ask_projects" },
            ...
            deces_ask_debts: { message: "4. Rămân pe umerii familiei credite sau datorii? Care ar fi suma necesară pentru a le stinge?", actionType: "input", options: { type: "number", placeholder: "Ex: 150000" }, nextStep: "deces_show_brute_deficit" },
            deces_show_brute_deficit: { message: "Am calculat necesarul total brut: **{bruteDeficit} lei**.\nAcum haide să vedem ce resurse există deja.", actionType: "buttons", options: ["Continuă"], nextStep: "deces_ask_insurance" },
            ...
            // =================================================
            // 3. SCENARIUL PENSIE (Cu Liste de Bifat)
            // =================================================
            ...
            // Input Suma
            pensie_ask_projects: { message: "Acum, fă un calcul total mental pentru aceste activități. Care ar fi suma anuală necesară (în lei)?", actionType: "input", options: { type: "number", placeholder: "Ex: 5000" }, nextStep: "pensie_ask_debts" },

            pensie_ask_debts: { message: "3. La vârsta pensionării, te aștepți să mai ai de plătit credite? Care ar fi suma necesară achitării lor?", actionType: "input", options: { type: "number", placeholder: "Ex: 0" }, nextStep: "pensie_ask_insurance" },
            ...
            pensie_ask_savings: { message: "5. Ai economii (Pilon 2, 3, investiții)? Ce sumă?", actionType: "input", options: { type: "number", placeholder: "Ex: 40000" }, nextStep: "pensie_show_final_result" },
            ...
            pensie_dramatic_options: { message: "Cum ți s-ar ajusta standardul de viață? Bifează:", actionType: "interactive_scroll_list", options: { buttonText: "Am înțeles", options: ["Reducerea alimentelor", "Limitarea utilităților", "Limitare medicală", "Munca la bătrânețe", "Apel la copii"] }, nextStep: "pensie_solution" },
            ...
            // =================================================
            // 4. SCENARIUL STUDII (Cu Liste de Bifat)
            // =================================================
            ...
            studii_intro_2: { message: "Vei răspunde la 6 întrebări pentru a stabili suma necesară pentru startul în viață.\n*Calculele sunt pentru un singur copil.", actionType: "buttons", options: ["Continuă"], nextStep: "studii_ask_years" },
            ...
            // Checklist 1
            studii_ask_annual_cost_list: { message: "Bifează cheltuielile pe care le-ar avea copilul tău dacă azi ar fi student:", actionType: "interactive_scroll_list", options: { buttonText: "Am selectat", options: ["Taxă școlarizare", "Cazare/Chirie", "Mâncare", "Transport", "Gadgeturi", "Cărți", "Distracție"] }, nextStep: "studii_ask_annual_cost" },
            // Input Suma 1
            studii_ask_annual_cost: { message: "Fă un calcul total mental: Care ar fi suma ANUALĂ necesară (în lei)?\n(Nu pune sumele „din burtă” =))", actionType: "input", options: { type: "number", placeholder: "Ex: 30000" }, nextStep: "studii_show_deficit_1" },
            studii_show_deficit_1: { message: "Am calculat costul de bază: **{deficit1} lei** (Sumă anuală x Ani). Continuăm.", actionType: "buttons", options: ["Continuă"], nextStep: "studii_ask_extra_list" },
            
            // Checklist 2
            studii_ask_extra_list: { message: "2. Pentru dezvoltare personală și socială. Bifează:", actionType: "interactive_scroll_list", options: { buttonText: "Am selectat", options: ["Tabere", "Hobby", "Ieșiri", "Călătorii", "Haine", "Cadouri"] }, nextStep: "studii_ask_extra" },
            // Input Suma 2
            ...
            studii_ask_wedding: { message: "4. Contribuția ta la nunta copilului. Care ar fi suma?", actionType: "input", options: { type: "number", placeholder: "Ex: 20000" }, nextStep: "studii_ask_savings" },
            studii_ask_savings: { message: "5. Există economii/investiții pe care copilul le-ar putea accesa acum?", actionType: "input", options: { type: "number", placeholder: "Ex: 5000" }, nextStep: "studii_ask_insurance" },
            studii_ask_insurance: { message: "6. Există vreo asigurare de viață cu economisire destinată copilului?", actionType: "input", options: { type: "number", placeholder: "Ex: 0" }, nextStep: "studii_ask_children_count" },
            ...
            // =================================================
            final_contact: {
              message: "Perfect. Lasă-mi datele tale pentru a-ți trimite analiza.",
              actionType: "form",
              options: {
                buttonText: "Trimite",
        ...
        setConfirmModalOpen(false);
        alert("Master Form Complet (4 Fluxuri) restaurat cu succes!");
