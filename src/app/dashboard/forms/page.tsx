...
export default function FormsPage() {
  ...
  const restoreMasterTemplate = async () => {
    if (!window.confirm("ATENȚIE: Această acțiune va șterge și regenera formularul Master. Ești sigur?")) return;

    try {
      // 1. Ștergem documentul vechi pentru a evita conflicte de date
      await deleteDoc(doc(db, "formTemplates", "master_standard_v1"));
      
      // 2. Definim structura completă (JSON Validat)
      const masterData = {
        ...
        startStepId: "intro_sequence", // Începem cu introducerea generală
        ownerId: null, // Null pentru a fi vizibil ca șablon standard
        isTemplate: true,
        createdAt: new Date(),
        flow: {
          ...
          // ============================================================
          // 2. SCENARIUL DECES (Conform fișierelor tale)
          // ============================================================
          deces_intro_1: {
          ...
          // ============================================================
          // 3. SCENARIUL PENSIONARE (Complet)
          // ============================================================
          pensie_intro_1: {
          ...
          // ============================================================
          // 4. SCENARIUL STUDII COPII (COMPLET)
          // ============================================================
          studii_intro_1: {
            message: [
      ...
      alert("Șablonul Master Complet (4 Fluxuri) a fost restaurat cu succes!");
      if (user) {
        await fetchForms(user);
      }
