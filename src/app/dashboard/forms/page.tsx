...
export default function FormsPage() {
    ...
    const restoreDatabase = async () => {
        ...
        setConfirmTitle("Resetare Șablon Standard");
        setConfirmDescription("Această acțiune va suprascrie șablonul 'Analiză Financiară - Deces (Standard)' cu versiunea originală. Continui?");
        setConfirmAction(() => action);
        setConfirmButtonText("Resetează");
  ...
  const restoreMasterTemplate = async () => {
    const action = async () => {
        ...
        setConfirmTitle("Resetare Șablon Master");
        setConfirmDescription("Această acțiune va suprascrie șablonul 'Analiză Completă (Master)' cu versiunea completă. Toate personalizările vor fi pierdute. Continui?");
        setConfirmAction(() => action);
        setConfirmButtonText("Resetează Master");
        setConfirmButtonVariant("destructive");
        setConfirmModalOpen(true);
    };
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Dialog open={isCreateModalOpen} onOpenChange={setIsCreateModalOpen}>
                    <DialogTrigger asChild>
                        <Button size="sm"><FilePlus2 className="mr-2 h-4 w-4"/> Creează Formular Nou</Button>
                    </DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
                            <DialogTitle>Creează un Formular Nou</DialogTitle>
                            <DialogDescription>
                                Dă un nume noului formular și alege un șablon de la care să pornești.
                            </DialogDescription>
                        </DialogHeader>
                        <div className="grid gap-4 py-4">
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    placeholder="Ex: Formular de test"
                                />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="template-select">Pornește de la un Șablon</Label>
            ...
            {loading ? (
                ...
                <>
                    <div>
                        <h2 className="text-lg font-semibold mb-3">Formularele Tale</h2>
                        {userForms.length > 0 ? (
                            ...
                            <p className="text-sm text-muted-foreground">Nu ai creat încă niciun formular. Poți crea unul nou sau clona un șablon.</p>
                        )}
                    </div>
                    
                    <div>
                        <h2 className="text-lg font-semibold mb-3">Șabloane Standard</h2>
                         {templateForms.length > 0 ? (
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                             ...
                             <p className="text-sm text-muted-foreground">Nu există șabloane disponibile. Puteți restaura șabloanele standard de mai jos.</p>
                         )}
                    </div>

                    <div className="mt-12 border-t pt-6">
                        <h2 className="text-lg font-semibold text-destructive">Zonă de Mentenanță</h2>
                        <p className="text-sm text-muted-foreground mb-4">Aceste acțiuni sunt ireversibile și vor suprascrie șabloanele existente.</p>
                        <div className="flex gap-4">
                           <Button variant="outline" onClick={restoreDatabase}>Resetează Șablonul Deces (Standard)</Button>
                           <Button variant="destructive" onClick={restoreMasterTemplate}>Creează Șablonul Master</Button>
                        </div>
                    </div>
                </>
            )}
            ...
            <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
                 <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                             Ești sigur că vrei să ștergi acest formular? Dacă este formularul activ, link-ul tău nu va mai funcționa până nu setezi altul. Această acțiune este permanentă.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
